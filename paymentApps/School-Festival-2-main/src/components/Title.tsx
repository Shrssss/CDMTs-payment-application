...
export const Title = ({ onStart, onOpenLegalNotice, hasSavedOrder, onViewSavedOrder }: TitleProps) => {
  return (
    <div style={wrap}>
      <div style={card}>
        {/* タイトル部分 */}
...
const savedOrderBtn: CSSProperties = {
  height: "48px",
  fontSize: "16px",
  fontWeight: "bold",
  borderRadius: "10px",
...
const noticeTitle: CSSProperties = { fontSize: "20px", marginBottom: "8px" };
const noticeList: CSSProperties = { fontSize: "15px", paddingLeft: "20px", lineHeight: "1.6" };
